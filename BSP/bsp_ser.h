...
void        BSP_Ser_Init  (CPU_INT08U   UardIdx, CPU_INT32U   baud_rate);

CPU_INT08U  BSP_Ser_RdByte(CPU_INT08U   UardIdx);
void        BSP_Ser_RdStr (CPU_INT08U   UardIdx,
	                       CPU_CHAR    *p_str,
                           CPU_INT16U   len);

void        BSP_Ser_WrByte(CPU_INT08U UardIdx, CPU_INT08U   c);
void        BSP_Ser_WrStr (CPU_INT08U UardIdx, CPU_CHAR  *p_str);
