...
//#define  BSP_GPIOA_LED2                          DEF_BIT_08
...
#define  BSP_GPIOB_PIN_01                        DEF_BIT_05
...
#define  BSP_GPIOE_LED2                          DEF_BIT_05
...
//void         BSP_IntHandlerTIM8_TRG      (void);
...
*/
// 串口端口定义
#define IO_PIN_UART1_RXD                 GPIO_Pin_10
#define IO_PORT_UART1_RXD                GPIOA
#define IO_CLK_UART1_RXD                 RCC_APB2Periph_GPIOA  
#define IO_PIN_UART1_TXD                 GPIO_Pin_9
#define IO_PORT_UART1_TXD                GPIOA
#define IO_CLK_UART1_TXD                 RCC_APB2Periph_GPIOA  

#define IO_PIN_UART2_RXD                 GPIO_Pin_3
#define IO_PORT_UART2_RXD                GPIOA
#define IO_CLK_UART2_RXD                 RCC_APB2Periph_GPIOA  
#define IO_PIN_UART2_TXD                 GPIO_Pin_2
#define IO_PORT_UART2_TXD                GPIOA
#define IO_CLK_UART2_TXD                 RCC_APB2Periph_GPIOA  

#define IO_PIN_UART3_RXD                 GPIO_Pin_11
#define IO_PORT_UART3_RXD                GPIOB
#define IO_CLK_UART3_RXD                 RCC_APB2Periph_GPIOB  
#define IO_PIN_UART3_TXD                 GPIO_Pin_10
#define IO_PORT_UART3_TXD                GPIOB
#define IO_CLK_UART3_TXD                 RCC_APB2Periph_GPIOB  

#define IO_PIN_UART4_RXD                 GPIO_Pin_11
#define IO_PORT_UART4_RXD                GPIOC
#define IO_CLK_UART4_RXD                 RCC_APB2Periph_GPIOC  
#define IO_PIN_UART4_TXD                 GPIO_Pin_10
#define IO_PORT_UART4_TXD                GPIOC
#define IO_CLK_UART4_TXD                 RCC_APB2Periph_GPIOC 


// 串口中断,时钟和优先级配置
#define UART1_BAUD                       115200
#define UART1_PRIO                       NVIC_PriorityGroup_0
#define UART1_CLK                        RCC_APB2Periph_USART1

#define UART2_BAUD                       19200
#define UART2_PRIO                       NVIC_PriorityGroup_1
#define UART2_CLK                        RCC_APB1Periph_USART2

#define UART3_BAUD                       9600
#define UART3_PRIO                       NVIC_PriorityGroup_2
#define UART3_CLK                        RCC_APB1Periph_USART3

#define UART4_BAUD                       115200
#define UART4_PRIO                       NVIC_PriorityGroup_3
...
typedef enum 
{
	...
	UART_PC      = nUART_4,          // 主通信串口	
	UART_RV      = nUART_2,
	UART_SYR     = nUART_3,
	UART_DEBUG   = nUART_1,          // 调试串口
} Uart_TypeDef;
...
extern OS_Q     MsgQueue[TASK_MSG_MAX];   
extern TASK_MSG stMsgHandle[TASK_MSG_MAX];
